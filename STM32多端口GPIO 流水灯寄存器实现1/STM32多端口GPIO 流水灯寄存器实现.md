...
![image-20260921000921741](C:\Users\zhang\AppData\Roaming\Typora\typora-user-images\image-20260921000921741.png)
...
![image-20260921132245567](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921132245567.png)

可以看出，总线矩阵连接到RCC，APB2 总线接GPIOA、GPIOB、GPIOC 。RCC 管理外设时钟，向 GPIO提供时钟信号。所以我们来查阅STM32中文参考手册得到他们的寄存器地址。

外设时钟寄存器地址

![image-20260921183333171](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921183333171.png)

可知RCC的基地址为0x40021000。

![image-20260921184417234](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921184417234.png)
...
![image-20260921213201332](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921213201332.png)

可以看到A、B、C三类端口基地址。

![image-20260922161721551](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260922161721551.png)

![image-20260922162142595](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260922162142595.png)
...
![image-20260921213731141](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921213731141.png)
...
![image-20260921135944890](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921135944890.png)

![image-20260921140059406](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921140059406.png)

:large_blue_diamond:其次创建main.c文件编写我们的主程序

![image-20260921140357342](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921140357342.png)

![image-20260921140318219](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921140318219.png)
...
![image-20260921141548523](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921141548523.png)

烧录我选择stlink下载。



![image-20260921140820661](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260921140820661.png)

编译无错误后，再进行烧录。



![image-20260922002906626](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260922002906626.png)

:large_blue_diamond:第一个实验为3个LED灯，轮流闪烁，间隔时长1秒。

实验现象为红蓝绿三个灯轮流亮：

![image-20260922003749853](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260922003749853.png)
...
![image-20260922004608633](STM32多端口GPIO 流水灯寄存器实现.assets/image-20260922004608633.png)
